...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SYNA_SRW1500_CLOCK_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SYNA_SRW1500_CLOCK_H_
...
#define SPI0_CTRL		0x1C
#define SPI1_CTRL		0x20
...
#define SYNA_SECURE_CLK		0x80000000U
...
#define SYNA_SPI0_CLK		((NO_CLK_ID << SER_ID) |  8 | (SPI0_CTRL << CTRL_REG))
#define SYNA_SPI1_CLK		((NO_CLK_ID << SER_ID) |  9 | (SPI1_CTRL << CTRL_REG))
#define SYNA_I3C_CLK		((NO_CLK_ID << SER_ID) | 10 | (I3C_CTRL << CTRL_REG))
#define SYNA_XSPI_CLK		((NO_CLK_ID << SER_ID) | 11 | (XSPI_CTRL << CTRL_REG))
#define SYNA_CAN0_CLK		((15 << SER_ID) | 16 | (CAN0_CTRL << CTRL_REG))
#define SYNA_CAN1_CLK		((16 << SER_ID) | 17 | (CAN1_CTRL << CTRL_REG))

#define SYNA_TRNG_CLK		(SYNA_SECURE_CLK | (14 << SER_ID) | 21)

#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_CLOCK_SYNA_SRW1500_CLOCK_H_ */
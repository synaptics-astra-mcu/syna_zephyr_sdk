...
.. zephyr-app-commands::
   :zephyr-app: zephyr_srsdk/samples/person_detection
...
``zephyr_srsdk/samples/person_detection/models/person_detection_256x480.tflite``
...
Pre-built interleaved test input binaries are provided in the ``zephyr_srsdk/samples/person_detection/inputs/``
...
below demonstrates the expected logs when inference runs.
